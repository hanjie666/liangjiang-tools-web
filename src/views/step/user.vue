...
<script>
import crudLjToolsKbsUser from '@/api/ljToolsKbsUser'
...
const defaultForm = { id: null, phone: null, password: null, registerTime: null, expirationTime: null, status: null, userId: null }
export default {
  name: 'LjToolsKbsUser',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '步数', url: 'api/ljToolsKbsUser', idField: 'id', sort: 'id,desc', crudMethod: { ...crudLjToolsKbsUser }})
  },
  data() {
    return {
      permission: {
